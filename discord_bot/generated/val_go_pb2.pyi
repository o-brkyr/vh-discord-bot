...
class ScheduleMessage(_message.Message):
    ...
    def __init__(self, weekday: _Optional[int] = ..., sessions: _Optional[_Iterable[_Union[Session, _Mapping]]] = ...) -> None: ...
...
class Session(_message.Message):
    ...
    end_time: str
    player_count: int
    def __init__(self, start_time: _Optional[str] = ..., end_time: _Optional[str] = ..., player_count: _Optional[int] = ...) -> None: ...
...
class ScheduleRequest(_message.Message):
    ...
    weekday: int
    session: Session
    def __init__(self, weekday: _Optional[int] = ..., session: _Optional[_Union[Session, _Mapping]] = ...) -> None: ...
...
class QueryPlayersResponse(_message.Message):
    ...
    def __init__(self, online: bool = ..., player_list: _Optional[_Iterable[_Union[PlayerData, _Mapping]]] = ...) -> None: ...
...
class PlayerData(_message.Message):
    ...
    member_name: str
    playtime_s: int
    def __init__(self, char_name: _Optional[str] = ..., member_name: _Optional[str] = ..., playtime_s: _Optional[int] = ...) -> None: ...
...
class QueryStatusResponse(_message.Message):
    ...
    def __init__(self, status: _Optional[_Union[QueryStatusResponse.Status, str]] = ...) -> None: ...
...
class RegisterRequest(_message.Message):
    ...
    snowflake: int
    char_name: str
    def __init__(self, snowflake: _Optional[int] = ..., char_name: _Optional[str] = ...) -> None: ...
...
class RegisterResponse(_message.Message):
    ...
    def __init__(self, characters: _Optional[_Iterable[_Union[PlayerData, _Mapping]]] = ...) -> None: ...
